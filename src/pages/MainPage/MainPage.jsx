    ...
    <div className={`${styles.mainPage} ${styles.fadeOut}`}>
      ...
      <section  className={styles.topDescriptionsBox}>
       <h1 className={styles.topDescriptions}>
          Бакінській Двір <br/>  - місце де смак об'єднує серця, <br/>
       ...
       <span className={styles.topDescriptions}>
        ...
        <h1 className={styles.bottomDescriptions}>
          Залишатесь на зв'язку, працюйте або діліться світлинами з відпочинку - <br/>
          у вільному доступі безкоштовний Wi-Fi
           <br/>
          Також, не переймайтеся за парковку. <br/> Зручне паркувальне місце, <br/>
